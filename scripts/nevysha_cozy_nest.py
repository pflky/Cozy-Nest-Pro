...
def on_ui_tabs():
    with gr.Blocks(analytics_enabled=False) as ui:
        with gr.Column(elem_id="nevyui-ui-block"):
            ...
            # header
            gr.HTML(value="<div class='nevysha settings-nevyui-top'><h2>Nevysha's Cozy Nest [customized by pflky]</h2>"
            ...
            with gr.Row():
                font_size = gr.Slider(value=config.get('font_size'), label="Font size", minimum=10, maximum=24, step=1,
            ...
            gr.HTML(value="<div class='nevysha settings-nevyui-bottom'>"
                          "  <p class='info'>Made by Nevysha with luv [customized by pflky with luv also]</p>"
